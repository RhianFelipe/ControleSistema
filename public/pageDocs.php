...
<body>
    ...
    <main>
        <section id="guia-utilizacao">
                    ...
                    <div id="tutorial1" style="display: none;">
                        <p>
                            ...
                            <strong>&lt;Inicial Maiúscula&gt;&lt;nome
                                sistema&gt;</strong>.
                            Para sistemas com permissão de administrador, adicione um parêntese indicando a função.
                            Exemplos:
                        </p>
                        <ul>
                            <li>Internet(adm)</li>
            ...
            <h3>Guia de Funções Gerais</h3>
            <p>Consulte o <a href="../docs/FunçõesGerais.pdf" target="_blank">Guia de Funções Gerais (PDF)</a> para
                obter informações de como utilizar as funções básicas.</p>

            <h3>Guia de Funções de Admin</h3>
            <p>Consulte o <a href="../docs/FunçõesAdmin.pdf" target="_blank">Guia de Funções de Admin (PDF)</a> para
                obter informações de como utiliar as funções de admin.
            </p>

            <hr style="border: 1px solid #ccc;">
            <p><strong>Esse projeto é Open Source, acesse o código pelo link: <a href="https://github.com/RhianFelipe/ControleSistema">CSSPR</a> </strong></p>
