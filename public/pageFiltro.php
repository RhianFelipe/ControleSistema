    ...
    <style>
        ...
        <nav class="navbar">
            ...
            <ul class="list-header">
                ...
                <li><a class="a1" id="botao-filtro-a" href="../public/pageFiltro.php">Filtrar Usuários</a></li>
                ...
                <tr class="linha-usuario" id="linha-usuario-<?php echo $resultado['id']; ?>">
                    ...
                    <td class="td-button">
                        ...
                        <button class="button-edit"
                            onclick="openModalEdit('<?php echo $resultado['id']; ?>')">Editar</button>
                        <button class="button-excluir"
                            onclick="apagarUsuarioDados('<?php echo $resultado['id']; ?>')">Excluir</button>
                    </td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
