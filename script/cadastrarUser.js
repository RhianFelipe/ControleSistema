...
document
  .getElementById("button-permissao")
  .addEventListener("click", abrirModalPermissoes);
...
document
  .getElementById("sistemaCadModal")
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          if (data.status) {
            ...
            const editSistemaModal = new bootstrap.Modal(
              document.getElementById("sistemaCadModal")
            );
